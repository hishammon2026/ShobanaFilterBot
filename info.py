...
API_ID = int(environ.get('API_ID', '28390522'))
API_HASH = environ.get('API_HASH', 'bb6e4438855b6c9ac8d9f0d999a664c4')
BOT_TOKEN = environ.get('BOT_TOKEN', '8627582266:AAHgTO-eh87dDxy5wIHCcB9TaN9asm8FBwI')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hishammon:hishammon@cluster0.2g7bqyf.mongodb.net/?appName=Cluster0")
...
FILE_CHANNELS = [int(ch) for ch in environ.get('FILE_CHANNELS', '-1003738723344').split()]
